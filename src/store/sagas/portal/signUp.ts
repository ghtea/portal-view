...
function* CreatePortal(action: actionsAuth.type__SIGN_UP) {
    try {
        ...
        if (action.payload.email === "") {
            ...
            yield put( actionsNotification.return__ADD_CODE_SITUATION_OTHERS({
                codeSituation: 'CreatePortal_NoEmail'
            }) );
            ...
            yield put( actionsNotification.return__ADD_CODE_SITUATION_OTHERS({
                codeSituation: 'CreatePortal_NotValidEmail'
            }) );
            ...
            yield put( actionsNotification.return__ADD_CODE_SITUATION_OTHERS({
                codeSituation: 'CreatePortal_NoPassword'
            }) );
            ...
            yield put( actionsNotification.return__ADD_CODE_SITUATION_OTHERS({
                codeSituation: 'CreatePortal_PasswordsDifferent'
            }) );
            ...
            yield put( actionsNotification.return__ADD_CODE_SITUATION_OTHERS({
                codeSituation: 'CreatePortal_ShortPassword'
            }) );
            //addDeleteNotification("auth04", language);
        }
            ...
            const res = yield call( requestCreatePortal, bodyRequest );
            console.log(res);
            ...
            if (codeSituation === 'CreatePortal_Succeeded') {
                ...
                // CreatePortal_UnknownError, CreatePortal_DuplicateEmail
                yield put( actionsNotification.return__ADD_CODE_SITUATION_OTHERS({
